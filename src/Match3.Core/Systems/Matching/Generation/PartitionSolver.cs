...
/// <summary>
/// Solves the optimal partition problem for bomb generation.
/// Uses a layered approach: exact solving for high-weight candidates, greedy for low-weight.
/// </summary>
internal static class PartitionSolver
{
    ...
    /// <summary>
    /// Finds the optimal partition of candidates that maximizes total weight.
    /// </summary>
    public static void FindOptimalPartition(
    ...
    private static void FindOptimalPartitionLayered(
        List<DetectedShape> candidates,
